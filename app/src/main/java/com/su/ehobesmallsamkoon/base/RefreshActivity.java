...
import com.su.ehobesmallsamkoon.ui.widget.ColorDividerDecoration;
import com.su.ehobesmallsamkoon.util.DisplayUtil;
import com.su.ehobesmallsamkoon.util.EmptyUtil;
...
public abstract class RefreshActivity<P extends IBasePresenter> extends ToolbarActivity<P> implements
    ...
    public void setLoadData(BaseQuickAdapter adapter, List<?> list, int emptyType) {
        Log.e(TAG, "setLoadData: " );
        this.emptyType = emptyType;
        adapter.setHeaderFooterEmpty(false, false);//是否显示头部和底部
