package com.su.ehobesmallsamkoon.ui.widget;
...
public class LoginButton extends View{
    ...
    int bg_color = Color.parseColor("#1DB1FF");
    String btnString = "登录";
    int rect_to_angle_duration = 200;
    int rect_to_circle_duration = 200;
    private Paint paint;
...
//        initPaint();
    ...
    private void setAnimator_point_move_up(){
        ...
        animator_point_move_up.setDuration(500);
